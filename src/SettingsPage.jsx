    ...
    <div className="pt-20 p-8 pb-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm mb-6 overflow-hidden">
          ...
          <div className="p-5 border-b border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors group">
          ...
          <div className="p-5 hover:bg-gray-50 cursor-pointer transition-colors group">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-gray-800 font-medium">Email Preferences</p>
          ...
          <div className="p-5 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-gray-800 font-medium">Public Profile</p>
          ...
          <div className="p-5 border-b border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors group">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-gray-800 font-medium">Blocked Users</p>
                  <p className="text-sm text-gray-500">Manage your blocked accounts</p>
                </div>
              </div>
              <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          <div className="p-5 hover:bg-gray-50 cursor-pointer transition-colors group">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-gray-800 font-medium">Language & Region</p>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border-2 border-red-100">
          ...
          <div className="p-5 border-b border-gray-200 hover:bg-red-50 cursor-pointer transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-800 font-medium">Deactivate Account</p>
          ...
          <div className="p-5 hover:bg-red-50 cursor-pointer transition-colors">
            <div className="flex items-center justify-between">
              <div>
        ...
        {/* Logout Button */}
        <div className="mt-6">
          <button className="w-full bg-gradient-to-r from-red-500 to-pink-500 text-white py-4 rounded-xl font-semibold hover:from-red-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
